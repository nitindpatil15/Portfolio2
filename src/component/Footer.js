  ...
  return (
    <>
      <footer className="mt-5 bg-slate-800 p-2 flex items-center justify-center">
        <div className="md:text-2xl text-base text-red-600 font-bold mx-2 md:mx-5">
          @Nitin D Patil
        </div>
        <div className="flex flex-row">
          ...
          >
            <img className=" text-white m-1 my-2 " src={Github} alt="Github" />
          </Link>
          <Link
            className="mx-2 w-5 md:w-8 rounded-full"
          ...
          <Link
            className="mx-2 w-5 md:w-8 rounded-full"
            to="https://twitter.com/NitinPa42701682"
          >
            <img
              className=" text-white my-2  m-1"
              src={Twitter}
